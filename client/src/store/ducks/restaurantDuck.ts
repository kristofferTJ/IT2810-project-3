...
export default function restaurantReducer(state: IRestaurant[]=[], action: RestaurantAction){
    switch(action.type) {
...
export function fetchRestaurants(
    ...
    axios
        .get(`http://localhost:8000/api/restaurant/?skip=${skip + filterString+searchString+sortString+ascendingString}`)
